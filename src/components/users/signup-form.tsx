...
export function SignupPage({ className, ...props }: React.ComponentProps<"div">) {
    ...
    const signupMutation = useMutation({
        mutationFn: (data: SignupFormValues) => axios.post("https://shopnest.zapto.org/api/auth/user/signup", data).then(res => res.data),
        onSuccess: (data) => {
            setEmail(data.data);
    ...
    const googleAuthMutation = useMutation({
        mutationFn: (credentialResponse: any) => axios.post("https://shopnest.zapto.org/api/auth/user/google", { credential: credentialResponse.credential }, { withCredentials: true }).then(res => res.data),
        onSuccess: (data) => {
