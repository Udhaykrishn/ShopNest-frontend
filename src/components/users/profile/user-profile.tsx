...
import { useProfile, useUserMutation } from '@/hooks/user/useUserProfile';
...
export function UserDashboard() {
  const { data: loaderData } = useProfile();
  ...
  useEffect(() => {
    if (loaderData && loaderData.data) {
      ...
      setFormData(extractUserData(loaderData.data));
    }
  }, [loaderData]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setUserData(prev => ({ ...prev, ...updatedFormData }));
      setOpen(false);
      ...
      <Card className="mb-6">
        <CardContent className="p-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-xl font-semibold text-foreground">{userData.username}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-6">
            <div>
              <div className="mb-4">
                ...
                <div className="text-foreground">{userData.username}</div>
              </div>
            ...
            <div>
              ...
              <div>
                ...
                <div className="text-foreground">{formatJoinDate(userData?.createdAt as string)}</div>
              </div>
            </div>
          </div>
