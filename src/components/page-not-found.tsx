...
export function NotFoundPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-900 flex flex-col items-center justify-center p-6 relative overflow-hidden">
            ...
            <div className={`z-10 transform transition-all duration-1000 ease-out ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'}`}>
                <div className="mb-8 relative">
                    <div className="text-9xl font-black text-center tracking-wider text-white relative">
                        <div className="relative inline-block">
                            <span className="absolute -left-1 -top-1 text-green-500/70">4</span>
                            <span className="absolute -left-0.5 -top-0.5 text-green-400/70">4</span>
                            <span className="relative">4</span>
                        </div>
                        <div className="relative inline-block">
                            <span className="absolute -left-1 -top-1 text-green-500/70">0</span>
                            <span className="absolute -left-0.5 -top-0.5 text-green-400/70">0</span>
                ...
                <div className={`text-center transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
                    <h2 className="text-4xl font-bold text-green-500 mb-4 animate-pulse">Page Not Found</h2>
